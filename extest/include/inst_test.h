...
/* 96 */
#define TEST_LL(data, base_addr, offset, offset_align, ref) \
    LI (t1, data); \
    LI (t0, base_addr); \
    LI (v1, ref); \
    sw t1, offset_align(t0); \
...
/* 97 */
#define TEST_SC(data, base_addr, offset, offset_align, ref) \
    LI (t1, data); \
    LI (t0, base_addr); \
    LI (v1, ref); \
    sc t1, offset(t0); \
...
/* 98 */
#define TEST_MADD(in_lo, in_hi, in_a, in_b, ref_lo, ref_hi) \
    li t0, in_lo; \
    mtlo t0; \
    li t1, in_hi; \
    mthi t1; \
...
/* 99 */
#define TEST_MADDU(in_lo, in_hi, in_a, in_b, ref_lo, ref_hi) \
    li t0, in_lo; \
    mtlo t0; \
    li t1, in_hi; \
    mthi t1; \
...
/* 100 */
#define TEST_MSUB(in_lo, in_hi, in_a, in_b, ref_lo, ref_hi) \
    li t0, in_lo; \
    mtlo t0; \
    li t1, in_hi; \
    mthi t1; \
...
/* 101 */
#define TEST_MSUBU(in_lo, in_hi, in_a, in_b, ref_lo, ref_hi) \
    li t0, in_lo; \
    mtlo t0; \
    li t1, in_hi; \
    mthi t1; \
