...
/* 4 */
#define TEST_BEQ(in_a, in_b, back_flag, front_flag, \
    b_flag_ref, f_flag_ref)                         \
  lui v0, 0x0;                                      \
  lui v1, 0x0;                                      \
  b 2000f;                                          \
  nop;                                              \
...
/* 5 */
#define TEST_BNE(in_a, in_b, back_flag, front_flag, \
    b_flag_ref, f_flag_ref)                         \
  lui v0, 0x0;                                      \
  lui v1, 0x0;                                      \
  b 2000f;                                          \
...
/* 13 */
#define TEST_J(                                    \
    back_flag, front_flag, b_flag_ref, f_flag_ref) \
  lui v0, 0x0;                                     \
  lui v1, 0x0;                                     \
  b 2000f;                                         \
  nop;                                             \
...
/* 37 */
#define TEST_BGEZ(                                       \
    in_a, back_flag, front_flag, b_flag_ref, f_flag_ref) \
  li v0, 0x0;                                            \
  li v1, 0x0;                                            \
  b 2000f;                                               \
  nop;                                                   \
...
/* 63 */
#define TEST_SB(                                           \
    init_data, data, base_addr, offset, offset_align, ref) \
  LI(t2, init_data);                                       \
  LI(t1, data);                                            \
  LI(t0, base_addr);                                       \
  LI(v1, ref);                                             \
...
/*76*/
#define TEST_RI_EX(inst) .word inst
